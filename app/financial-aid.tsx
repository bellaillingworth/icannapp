      ...
      <ScrollView style={styles.container}>
        <ThemedView style={styles.content}>
          ...
          <ThemedView style={styles.section}>
            ...
            <ThemedView style={styles.step}>
              ...
              <ThemedText style={styles.text}>
                ...
                • <ThemedText style={{ fontWeight: 'bold', color: '#007dc3' }}> Student Loans:</ThemedText>Free Must be paid back with interest after graduation
            </ThemedText>
            </ThemedView>
          ...
          <ThemedView style={styles.logoContainer}>
            ...
            >
            <Image
              source={require('@/assets/images/ICAN - Financial Aid Guide Cover_2025_rbg.png')}
              style={styles.logo}
              resizeMode="contain"
            />
            </Pressable>
